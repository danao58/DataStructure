...
public class SingleLinkedList {
        private HeroNode head=new HeroNode(0,"","");//头节点(固定)

        public void addByOrder(HeroNode heroNode){//有序的链表
        ...
        public void add(HeroNode heroNode){//添加列表
            HeroNode temp=head;
            while (true){
                if (temp.next==null){
                    break;//找到最后节点退出循环
        ...
        public void update(HeroNode newHeroNode){//按节点修改名称和昵称
